...
class COCOeval:
    ...
    def summarize(self):
        ...
        # print('iou=0.75, maxdet=100: {:0.3f}'.format(np.mean(s[5, :, :, :, 2])))
        # print('iou=0.5:0.95, maxdet=10: {:0.3f}'.format(np.mean(r[:, :, :, 1])))
        # print('iou=0.5:0.95, maxdet=100: {:0.3f}'.format(np.mean(r[:, :, :, 2])))
