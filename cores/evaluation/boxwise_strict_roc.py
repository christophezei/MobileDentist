...
def plot(maxiou_match, maxiou_confidence, num_class):
    ...
    for i in range(num_class):
        ...
        plt.legend()
        plt.savefig(dir_path + '/visualization/boxwise_strict_roc_{}.png'.format(i))
        ...
        plt.savefig(dir_path + '/visualization/boxwise_strict_prc_{}.png'.format(i))
