...
from server_deploy.nms import multiclass_nms
...
class SSDHead(nn.Module):
    ...
    def __init__(
        ...
        self.basesize_ratios = basesize_ratios
        ...
        for k in range(len(self.anchor_strides)):
            ...
            base_size_ratio = basesize_ratios[k]
            base_size_ratio = int(base_size_ratio * 100)
            base_size = (int(input_size[0] * base_size_ratio / 100), int(input_size[1] * base_size_ratio / 100))
